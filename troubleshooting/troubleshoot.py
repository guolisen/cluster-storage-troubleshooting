...
async def run_analysis_phase_wrapper(pod_name: str, namespace: str, volume_path: str, 
                                  ...
                                  config_data: Dict[str, Any] = None, message_list: List[Dict[str, str]] = None) -> Tuple[str, bool, List[Dict[str, str]]]:
    """
...
"""
        ...
        while True:
            ...
            phase1_final_response, skip_phase2, phase1_message_list = await run_analysis_phase_wrapper(
                pod_name, namespace, volume_path, collected_info, investigation_plan, CONFIG_DATA, phase1_message_list
            )
